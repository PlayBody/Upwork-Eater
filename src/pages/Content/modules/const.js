const Constants = {
  ...
  OtherControls: {
    ...
    signUpFreelancerRadio: 'input[type="radio"][aria-labelledby="button-box-4"][class="up-button-box-input"][value="work"]',
    ...
    resumeRemoveBtn: 'button[data-qa="resume-remove-btn"][class="air3-btn air3-btn-link air3-btn-circle"]',
    ...
    skillsInput: 'input[aria-labelledby="skills-input"][type="search"]',
    skillsSearch: 'ul[aria-labelledby="skills-input"]',
